      ...
      <div class="column">
        ...
        <form v-on:submit.prevent="onSubmit">
          ...
          <div class="socialbtns">
            <button
              type="submit"
              class="login-button socialbtn__facebook"
              title="Zaloguij się przy użyciu konta facebook"
            >
              <svg-icon icon="facebook" />
            </button>
            <button
              type="submit"
              class="login-button socialbtn__gmail"
              title="Zaloguj się przy użyciu konta gmail"
            >
          ...
          <router-link to="/register" class="login-button register-button"
